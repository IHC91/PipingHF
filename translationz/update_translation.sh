...
# - The script has to be executed within the `translationz` directory.
...
# - Once done, download the translated files, copy them to `translationz`
...
update_locale() {
  ...
  FILES="../*.py ../cut_list/*.py ../dialogz/*.ui ../cut_list/resources/*.ui"
